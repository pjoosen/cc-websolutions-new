...
function rocknrolla_video($atts) {
	...
	if($type == "vimeo") $rnr_video = "<div data-effect='".$animation."' class='video-embed rnr-animate animated'><iframe src='http://player.vimeo.com/video/$id?autoplay=$autoplay&amp;title=0&amp;byline=0&amp;portrait=0' width='$width' height='$height' class='iframe'></iframe></div>";
